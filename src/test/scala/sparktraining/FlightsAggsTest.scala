...
class FlightsAggsTest extends WordSpec with Matchers with DatasetSuiteBase {
    ...
    "FlightAggs" should {
        ...
        "calculate top N carriers" in {
            ...
            // when
            val top_n: Dataset[CarrierDelayStats] = FlightsAggs.topNCarriers(input, carriers)(5, ascending = true)
            ...
            assertDatasetEquals(top_n.map(_.copy(carrierName = "")), expectedDs)
        }
        ...
        "calculate top N carriers when N is > count of carriers" in {
            ...
            // when
            val top_n: Dataset[CarrierDelayStats] = FlightsAggs.topNCarriers(input, carriers)(10, ascending = true)
        ...
        "calculate the worse N carriers" in {
            ...
            // when
            val top_n: Dataset[CarrierDelayStats] = FlightsAggs.topNCarriers(input, carriers)(2, ascending = false)
